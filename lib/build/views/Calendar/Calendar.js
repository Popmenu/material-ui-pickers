...
exports.styles = exports.Calendar = void 0;
...
var Calendar = /** @class */ (function (_super) {
    ...
    function Calendar() {
        ...
        _this.handleKeyDown = function (event) {
            ...
            (0, useKeyDown_1.runKeyHandler)(event, {
        ...
        _this.renderWeeks = function () {
            ...
            return weeks.map(function (week) { return (React.createElement("div", { key: "week-".concat(week[0].toString()), className: classes.week }, _this.renderDays(week))); });
        };
    ...
    Calendar.prototype.componentDidMount = function () {
        ...
        if (this.shouldDisableDate(date)) {
            var closestEnabledDate = (0, date_utils_1.findClosestEnabledDate)({
                date: date,
                utils: utils,
    ...
    Calendar.prototype.render = function () {
        ...
        return (React.createElement(React.Fragment, null,
            ...
            React.createElement(SlideTransition_1.default, { slideDirection: slideDirection, transKey: currentMonth.toString(), className: classes.transitionContainer }, function (nodeRef) {
                return _this.state.loadingQueue > 0 ? (React.createElement("div", { ref: nodeRef, className: classes.progressContainer }, loadingElement)) : (React.createElement("div", { ref: nodeRef }, _this.renderWeeks()));
            })));
    };
...
exports.default = (0, styles_1.withStyles)(exports.styles, {
    ...
    withTheme: true,
})((0, WithUtils_1.withUtils)()(Calendar));
