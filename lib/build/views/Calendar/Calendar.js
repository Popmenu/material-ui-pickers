    ...
    function Calendar() {
        ...
        _this.renderDays = function (week) {
            ...
            return week.map(function (day) {
                ...
                var dayComponent = (React.createElement(Day_1.default, { disabled: disabled, current: utils.isSameDay(day, now), hidden: !isDayInCurrentMonth, selected: utils.isSameDay(selectedDate, day) }, utils.format(day, 'dayOfMonth')));
                if (renderDay) {
