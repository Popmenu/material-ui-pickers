...
var PickerToolbar = function (_a) {
    ...
    return (React.createElement(Toolbar_1.default, __assign({ className: (0, clsx_1.default)(classes.toolbar, (_b = {}, _b[classes.toolbarLandscape] = isLandscape, _b), className) }, other), children));
};
