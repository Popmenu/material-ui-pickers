...
var useValueToDate = function (utils, _a) {
    ...
    var nowRef = (0, react_1.useRef)(utils.date());
...
function usePickerState(props, options) {
    ...
    var utils = (0, useUtils_1.useUtils)();
    var _a = (0, useOpenState_1.useOpenState)(props), isOpen = _a.isOpen, setIsOpen = _a.setIsOpen;
    var _b = useDateValues(props, options), date = _b.date, format = _b.format;
    var _c = (0, react_1.useState)(date), pickerDate = _c[0], setPickerDate = _c[1];
    ...
    var acceptDate = (0, react_1.useCallback)(function (acceptedDate) {
    ...
    var wrapperProps = (0, react_1.useMemo)(function () { return ({
        format: format,
        open: isOpen,
    ...
    var pickerProps = (0, react_1.useMemo)(function () { return ({
        date: pickerDate,
    ...
    var validationError = (0, text_field_helper_1.validate)(value, utils, props);
    (0, react_1.useEffect)(function () {
        if (onError) {
            onError(validationError, value);
        }
    }, [onError, validationError, value]);
    var inputValue = (0, text_field_helper_1.getDisplayDate)(date, format, utils, value === null, props);
    var inputProps = (0, react_1.useMemo)(function () { return ({
    ...
    (0, react_1.useDebugValue)(pickerState);
    return pickerState;
}
