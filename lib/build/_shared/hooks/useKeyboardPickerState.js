...
function useKeyboardPickerState(props, options) {
    ...
    var displayDate = (0, text_field_helper_1.getDisplayDate)(value, format, utils, value === null, props);
    var _b = (0, react_1.useState)(displayDate), innerInputValue = _b[0], setInnerInputValue = _b[1];
    ...
    var handleKeyboardChange = (0, react_1.useCallback)(function (date) {
        onChange(date, date === null ? null : utils.formatByString(date, format));
    }, [format, onChange, utils]);
    var _c = (0, usePickerState_1.usePickerState)(__assign(__assign({}, props), { value: dateValue, onChange: handleKeyboardChange }), options), innerInputProps = _c.inputProps, wrapperProps = _c.wrapperProps, pickerProps = _c.pickerProps;
    var inputProps = (0, react_1.useMemo)(function () { return (__assign(__assign({}, innerInputProps), { format: wrapperProps.format, inputValue: inputValue || innerInputValue, onChange: function (value) {
