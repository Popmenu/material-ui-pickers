...
var defaultKeyboardIcon = React.createElement(KeyboardIcon_1.KeyboardIcon, null);
var KeyboardDateInput = function (_a) {
    var inputValue = _a.inputValue, inputVariant = _a.inputVariant, validationError = _a.validationError, KeyboardButtonProps = _a.KeyboardButtonProps, InputAdornmentProps = _a.InputAdornmentProps, onOpen = _a.openPicker, onChange = _a.onChange, InputProps = _a.InputProps, mask = _a.mask, _b = _a.maskChar, maskChar = _b === void 0 ? '_' : _b, _c = _a.refuse, refuse = _c === void 0 ? /[^\d]+/gi : _c, format = _a.format, _d = _a.keyboardIcon, keyboardIcon = _d === void 0 ? defaultKeyboardIcon : _d, disabled = _a.disabled, rifmFormatter = _a.rifmFormatter, _e = _a.TextFieldComponent, TextFieldComponent = _e === void 0 ? TextField_1.default : _e, other = __rest(_a, ["inputValue", "inputVariant", "validationError", "KeyboardButtonProps", "InputAdornmentProps", "openPicker", "onChange", "InputProps", "mask", "maskChar", "refuse", "format", "keyboardIcon", "disabled", "rifmFormatter", "TextFieldComponent"]);
    var inputMask = mask || (0, text_field_helper_1.makeMaskFromFormat)(format, maskChar);
    // prettier-ignore
    var formatter = React.useMemo(function () { return (0, text_field_helper_1.maskedDateFormatter)(inputMask, maskChar, refuse); }, [inputMask, maskChar, refuse]);
