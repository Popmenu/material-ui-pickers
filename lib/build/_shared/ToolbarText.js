...
exports.useStyles = (0, styles_1.makeStyles)(function (theme) {
    ...
    return {
        toolbarTxt: {
            color: (0, styles_1.fade)(textColor, 0.54),
        },
        toolbarBtnSelected: {
            color: textColor,
        },
...
var ToolbarText = function (_a) {
    ...
    return (React.createElement(Typography_1.default, __assign({ children: label, className: (0, clsx_1.default)(classes.toolbarTxt, className, (_b = {},
