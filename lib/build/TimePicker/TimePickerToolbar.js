...
var TimePickerToolbar = function (_a) {
    ...
    return (React.createElement(PickerToolbar_1.default, { isLandscape: isLandscape, className: (0, clsx_1.default)((_b = {},
        ...
        React.createElement("div", { className: (0, clsx_1.default)(classes.hourMinuteLabel, (_c = {},
                ...
                _c)) },
            (0, utils_1.arrayIncludes)(views, 'hours') && (React.createElement(ToolbarButton_1.default, { variant: clockTypographyVariant, onClick: function () { return setOpenView(ClockType_1.default.HOURS); }, selected: openView === ClockType_1.default.HOURS, label: utils.getHourText(date, Boolean(ampm)) })),
            ...
            (0, utils_1.arrayIncludes)(views, 'minutes') && (React.createElement(ToolbarButton_1.default, { variant: clockTypographyVariant, onClick: function () { return setOpenView(ClockType_1.default.MINUTES); }, selected: openView === ClockType_1.default.MINUTES, label: utils.getMinuteText(date) })),
            ...
            (0, utils_1.arrayIncludes)(views, 'seconds') && (React.createElement(ToolbarButton_1.default, { variant: "h2", onClick: function () { return setOpenView(ClockType_1.default.SECONDS); }, selected: openView === ClockType_1.default.SECONDS, label: utils.getSecondText(date) }))),
