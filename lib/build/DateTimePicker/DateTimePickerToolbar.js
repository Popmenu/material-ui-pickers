...
exports.DateTimePickerToolbar = exports.useStyles = void 0;
...
exports.useStyles = (0, styles_1.makeStyles)(function (_) { return ({
    toolbar: {
        paddingLeft: 16,
        paddingRight: 16,
...
var DateTimePickerToolbar = function (_a) {
    ...
    var _b = (0, TimePickerToolbar_1.useMeridiemMode)(date, ampm, onChange), meridiemMode = _b.meridiemMode, handleMeridiemChange = _b.handleMeridiemChange;
        ...
        React.createElement(PickerToolbar_1.default, { isLandscape: false, className: classes.toolbar },
            React.createElement(Grid_1.default, { container: true, justify: "center", wrap: "nowrap" },
                React.createElement(Grid_1.default, { item: true, container: true, xs: 5, justify: "flex-start", direction: "column" },
                    ...
                    React.createElement("div", null,
                        React.createElement(ToolbarButton_1.default, { variant: "h4", onClick: function () { return setOpenView('date'); }, selected: openView === 'date', label: utils.format(date, 'normalDateWithWeekday') }))),
                React.createElement(Grid_1.default, { item: true, container: true, xs: 6, justify: "center", alignItems: "flex-end", direction: rtl ? 'row-reverse' : 'row' },
                    React.createElement(ToolbarButton_1.default, { variant: "h3", onClick: function () { return setOpenView('hours'); }, selected: openView === 'hours', label: utils.format(date, ampm ? 'hours12h' : 'hours24h') }),
                    React.createElement(ToolbarText_1.default, { variant: "h3", label: ":", className: classes.separator }),
                    React.createElement(ToolbarButton_1.default, { variant: "h3", onClick: function () { return setOpenView('minutes'); }, selected: openView === 'minutes', label: utils.format(date, 'minutes') })),
