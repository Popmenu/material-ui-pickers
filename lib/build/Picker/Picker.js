...
var PickerImpl = function (_a) {
    ...
    var isLandscape = (0, useIsLandscape_1.useIsLandscape)(orientation);
    var _d = (0, useViews_1.useViews)(views, openTo, onChange), openView = _d.openView, setOpenView = _d.setOpenView, handleChangeAndOpenNext = _d.handleChangeAndOpenNext;
    ...
    return (React.createElement("div", { className: (0, clsx_1.default)(classes.container, (_b = {},
        ...
        React.createElement("div", { className: (0, clsx_1.default)(classes.pickerView, (_c = {}, _c[classes.pickerViewLandscape] = isLandscape, _c)) },
...
var Picker = /** @class */ (function (_super) {
    ...
    Picker.prototype.render = function () {
        return React.createElement(PickerImpl, __assign({}, this.props));
    };
    Picker.defaultProps = __assign(__assign({}, prop_types_1.datePickerDefaultProps), { views: Object.keys(viewsMap) });
    return Picker;
}(React.Component));
