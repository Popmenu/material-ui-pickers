...
var Picker = /** @class */ (function (_super) {
    ...
    Picker.prototype.render = function () {
        var _a, _b;
        var _c = this.props, date = _c.date, views = _c.views, disableToolbar = _c.disableToolbar, onChange = _c.onChange, openTo = _c.openTo, unparsedMinDate = _c.minDate, unparsedMaxDate = _c.maxDate, ToolbarComponent = _c.ToolbarComponent, orientation = _c.orientation, rest = __rest(_c, ["date", "views", "disableToolbar", "onChange", "openTo", "minDate", "maxDate", "ToolbarComponent", "orientation"]);
