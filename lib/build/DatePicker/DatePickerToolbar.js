...
var DatePickerToolbar = function (_a) {
    ...
    return (React.createElement(PickerToolbar_1.default, { isLandscape: isLandscape, className: (0, clsx_1.default)((_b = {},
            ...
            _b)) },
        React.createElement(ToolbarButton_1.default, { variant: isYearOnly ? 'h3' : 'subtitle1', onClick: function () { return setOpenView('year'); }, selected: openView === 'year', label: utils.format(date, 'year') }),
        !isYearOnly && !isYearAndMonth && (React.createElement(ToolbarButton_1.default, { variant: "h4", selected: openView === 'date', onClick: function () { return setOpenView('date'); }, align: isLandscape ? 'left' : 'center', label: utils.format(date, 'shortDate'), className: (0, clsx_1.default)((_c = {}, _c[classes.dateLandscape] = isLandscape, _c)) })),
        isYearAndMonth && (React.createElement(ToolbarButton_1.default, { variant: "h4", onClick: function () { return setOpenView('month'); }, selected: openView === 'month', label: utils.format(date, 'month') }))));
};
